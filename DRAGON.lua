...
local UserName = (data.username_ or "e_l_m_o_l_k")
...
local Text = [[ 
[قناه سورس الملوك ادخل وتابع الجديد](t.me/e_l_m_o_l_k)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/e_l_m_o_l_k)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/e_l_m_o_l_k"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_,0," ♔ الـعـضو  : {["..data.first_name_.."](T.ME/e_l_m_o_l_k)}\n ♔ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ♔ عذرا  ⇦♔{["..data.first_name_.."](T.ME/e_l_m_o_l_k)}\n ♔ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if text == 'تيمو' or text == 'مبرمج السورس' or text == 'مبرمج تيمو' or text == 'TIMO' then 
local msg_id = msg.id_/2097152/0.5  
local Text = [[ 
...
if text == 'اشرقت' or text == 'شوشو' or text == 'الملكه' or text == 'الماما' then 
local msg_id = msg.id_/2097152/0.5  
local Text = [[ 
...
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/ASHR_AKAT&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
function(arg,data) 
usertext = '\n ♔ الـعـضو   ⇦♔['..data.first_name_..'](t.me/'..(data.username_ or 'e_l_m_o_l_k')..')'
...
usertext = '\n ♔ الـعـضو   ⇦♔['..result.title_..'](t.me/'..(username or 'e_l_m_o_l_k')..')'
status  = '\n ♔ تم حظرو عام من الجروبات '
texts = usertext..status
...
' }\nء⧬━┅┅┄⟞❲[𝚂𝙾𝚄𝚁𝙲𝙴 𝙷??𝙶𝙰𝙽](t.me/e_l_m_o_l_k)❳⟝┄┉┉━⧬'..
'\n ♔  علامة ال {✓} تعني مفعل'..
'\n ♔  علامة ال {✘} تعني معطل'..
'\nء♽^━━━━❆𝗘𝗟𝗠𝗟𝗢𝗞❆━━━━^♽ '..
'\n'..' ♔  امر صيح  ⇦♔{ '..kickme..
...
' }\n'..' ♔  الايدي بالصوره  ⇦♔{ '..idph..
' }\n'..' ♔  الرفع  ⇦♔{ '..setadd..
' }\n'..' ♔  الحظر  ⇦♔{ '..banm..' }\n\n ♔❲[♔ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝙼𝙻𝙾𝙺 ](t.me/e_l_m_o_l_k)❳ ♔\n ♔ قناة سورس الملوك♽^━━━━❆𝗘𝗟𝗠𝗟𝗢𝗞❆━━━━^♽ \n [ ❲[♔ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝙼𝙻𝙾𝙺 ](t.me/e_l_m_o_l_k)❳](t.me/e_l_m_o_l_k) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' 《𝚂𝙾𝚄𝚁𝙲𝙴 𝙷𝙾??𝙰??》', url="t.me/e_l_m_o_l_k"}},
}
local msg_id = msg.id_/2097152/0.5
...
•┉ • ┉ • ┉ 《 𝐸𝐿𝑀𝐿𝑂𝐾》 ┉ • ┉ • ┉•
 ...
 ♔ مسح الجروبات
•┉ • ┉ • ┉ 《𝐸𝐿𝑀𝐿𝑂𝐾》 ┉ • ┉ • ┉•
➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲e 𝐸𝐿𝑀𝐿𝑂𝐾.](t.me/e_l_m_o_l_k)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '( source 𝐸𝐿𝑀𝐿𝑂𝐾 )', url="t.me/e_l_m_o_l_k"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
