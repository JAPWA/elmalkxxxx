...
if res ~= 200 then
print('\27[0;31m◄-----------『𝑬𝑳𝑴𝑳𝑲』----------►\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na◄-----------『𝑬𝑳𝑴𝑳𝑲』----------►\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m◄-----------『𝑬𝑳𝑴𝑳𝑲』----------► ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
send(msg.chat_id_, msg.id_,' ☆︙ اصدار سورس الملك { s: 6.7}')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/e_l_m_l_k"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[TWL](t.me/TWASL_TIMO_BOT)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'تواصل السورس 📬', url="t.me/TWASL_TIMO_BOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
send(msg.chat_id_,0," ☆︙ العضو : {["..data.first_name_.."](t.me/e_l_m_l_k)}\n ☆︙ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ☆︙ عذرا ↫ {["..data.first_name_.."](t.me/e_l_m_l_k)}\n ☆︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[ 
╭━━━━━❲☆[𝑬𝑳𝑴𝑳𝑲](t.me/e_l_m_l_k)☆❳━━━━━╮
[𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑳𝑲](t.me/e_l_m_l_k)
[𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽❳ ❲𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼](t.me/e_l_m_l_k)
╰━━━━━❲☆[𝑬𝑳𝑴𝑳𝑲](t.me/e_l_m_l_k)☆❳━━━━━╯
]]
keyboard = {}
keyboard.inline_keyboard = {
{{text = '𝑫𝑬𝑽 𝑻𝑰𝑴𝑶',url="t.me/ttimo_2lby"}},
{{text = '𝑨𝑩𝑶 𝑬𝑳𝑴𝑨𝑮𝑫',url="t.me/ABO_ELMAGD2"}},
{{text = '𝑶𝑴𝑨𝑹',url="t.me/teemElmelok"}},
{{text = '𝑺𝑶𝑼𝑹𝑪𝑬 𝑬𝑳𝑴𝑳𝑲', url="t.me/e_l_m_l_k"}},
}
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/e_l_m_l_k/10&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'مين نصبلك' or text == 'عايزه بوت' or text == 'عايز بوت' then
local Text = [[
 ☆ اهلا بك في سورس الملك الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني  ☆ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'DEV TIMO',url="t.me/ttimo_2lby"}},
{{text = '𝑨𝑩𝑶 𝑬𝑳𝑴𝑨𝑮𝑫 ',url="t.me/ABO_ELMAGD2"}},
{{text = '𝑶𝑴𝑨𝑹',url="t.me/teemElmelok"}},
{{text = '⁽♔₎ 𝑬𝑳𝑴𝑳𝑲|:☁ ', url="t.me/e_l_m_l_k"}},
{{text = 'تواصل السورس ',url="t.me/"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'عمر' or text == 'عمر' or text == 'مبروج السورس4' then
local Text = [[
مبرمج سورس الملك
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝑫𝑬𝑽 𝑶𝑴𝑨𝑹',url="t.me/teemElmelok"}},
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴', url="t.me/e_l_m_l_k"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'تيمو' or text == 'تيمو' or text == 'مبرمج السورس' then
local Text = [[
المبرمج تيمو لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if text == 'ابو المجد' or text == 'ابو المجد' or text == '⌯ مبرمج السورس2 ⌯' then
local Text = [[
𝑨𝑩𝑶 𝑬𝑳𝑴𝑨𝑮𝑫.!🇨🇼
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ᯓ˹ 𝑨𝑩𝑶 𝑬𝑳𝑴𝑨𝑮𝑫˼𖠱',url="t.me/ABO_ELMAGD2"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.meABO_ELMAGD2/&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'مصطفي' or text == 'جابوا' or text == 'مبرمج السورس3' then
local Text = [[
مبرمج سورس الملك
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ᯓ𝑫𝑬𝑽 𝑱𝑨𝑩𝑾𝑨',url="t.me/J_A_B_W_A"}},
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴', url="t.me/e_l_m_l_k"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس ✅', url="t.me/e_l_m_l_k"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/aslak8/6&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=http://t.me/e_l_m_l_k/4/25&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'العاب الملك' or text == 'العاب مطوره' or text == 'الالعاب' then  
local Text = [[  
...
elseif text == 'قفل الملكرسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
...
elseif text == 'فتح الملكرسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
...
function(arg,data) 
usertext = '\n ☆︙ العضو ↫ ['..data.first_name_..'](t.me/'..(data.username_ or '@e_l_m_l_k')..')'
...
send(msg.chat_id_, msg.id_, " ☆︙ لا يمكنك حظر المبرمج تيمو \n")
return false 
end
if result.id_ == tonumber(1853574370) then
send(msg.chat_id_, msg.id_, " ☆︙ لا يمكنك حظر عمك ابو المجد \n")
return false 
end
if result.id_ == tonumber(2094348305) then
send(msg.chat_id_, msg.id_, " ☆︙ لا يمكنك حظر المبرمج عمر \n")
return false 
end
if result.id_ == tonumber(1965534755) then
send(msg.chat_id_, msg.id_, " ☆︙ لا يمكنك حظر الشيخ جابوا \n")
return false 
end
usertext = '\n ☆︙ العضو ↫ ['..result.title_..'](t.me/'..(username or '@e_l_m_l_k')..')'
...
if tonumber(userid) == tonumber(2094348305) then  
send(msg.chat_id_, msg.id_, " ☆︙ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(2094348305) then  
send(msg.chat_id_, msg.id_, " ☆︙لا تستطيع كتم الواد عمر عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1853574370) then  
send(msg.chat_id_, msg.id_, " ☆︙ لا تستطيع كتم ابو المجد عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1965534755) then  
send(msg.chat_id_, msg.id_, " ☆︙ لا تسطيع كتم الشيخ جابوا عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/TIMOXBODY/elmalkxxxx/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ☆︙ اهلا بك في متجر ملفات الملك\n ☆︙ ملفات السورس ↓\n◄-----------『𝑬𝑳𝑴𝑳𝑲』----------►\n\n"
local TextE = "\n◄-----------『𝑬𝑳𝑴𝑳𝑲』----------►\n ☆︙ علامة تعني { ✔️ } ملف مفعل\n ☆︙ علامة تعني { ✖ } ملف معطل\n ☆︙ قناة سورس الملك ↓\n".." ☆︙ [اضغط هنا لدخول](t.me/e_l_m_l_k) \n"
local NumFile = 0
...
if Mod(msg) then     
if AddChannel(msg.sender_user_id_) == false then
local e_l_m_l_k = database:get(bot_id..'text:ch:user')
if e_l_m_l_k then
send(msg.chat_id_, msg.id_,'['..e_l_m_l_k..']')
else
send(msg.chat_id_, msg.id_,' 🕊 لا تستطيع استخدام البوت \n  🕊 يرجى الاشتراك بالقناه اولا \n  🕊 اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
...
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '  ❨𝐚𝐡𝐦𝐞𝐝 𝐚𝐥𝐦𝐬𝐫𝐲❩ ', url="t.me/ttimo_2lby"}},
{{text = '❨ اضف البوت لمجموعتك ❩', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}  
local msg_id = msg.id_/2097152/0.5  
...
end --الكود حصري سورس الملك يعني لو بكتهن راح اعرفك انت الاخذتهن
...
if text == 'بوتي' then 
send(msg.chat_id_,msg.id_, '[قلب بوتكك من جواا 🥺♥️](t.me/e_l_m_l_k)') 
return false
end
...
send(msg.chat_id_, msg.id_,'['..ttimo_2lby[math.random(#ttimo_2lby)]..']') 
return false
end
...
Namebot = ttimo_2lby[math.random(#ttimo_2lby)] 
local msg_id = msg.id_/2097152/0.5  
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  ❨𝗦𝗢𝗨𝗥𝗖𝗘❩ ', url="t.me/e_l_m_l_k"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
} 
local function getpro(extra, result, success) 
if result.photos_[0] then 
...
{
{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑳𝑲', url="t.me/e_l_m_l_k"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
